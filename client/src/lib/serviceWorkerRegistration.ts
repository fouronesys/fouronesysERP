    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log(
            'Esta aplicación web está siendo servida por cache mediante un service worker. ' +
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log(
                'Nuevo contenido disponible y será usado cuando todas las ' +
                'pestañas de esta página sean cerradas. Para más información, visita https://bit.ly/CRA-PWA.'
              );
